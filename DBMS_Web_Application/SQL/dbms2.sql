...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2018 at 10:20 PM
...
ALTER TABLE `student`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `student_ibfk_1` (`dept_name`);
...
--
ALTER TABLE `student`
  ADD CONSTRAINT `student_ibfk_1` FOREIGN KEY (`dept_name`) REFERENCES `department` (`dept_name`) ON DELETE SET NULL ON UPDATE SET NULL;
